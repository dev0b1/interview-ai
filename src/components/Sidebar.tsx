...
export default function Sidebar({ onClose }: { onClose?: () => void } = {}) {
  ...
  <NavLink href="/interview" label="Interviews" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M9 2a1 1 0 00-1 1v3H5a1 1 0 100 2h3v3a1 1 0 102 0V8h3a1 1 0 100-2H11V3a1 1 0 00-1-1z"/></svg>} />
